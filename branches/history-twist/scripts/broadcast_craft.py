#!/usr/bin/env python3
"""Broadcast Craft CLI – History Twist Orchestrator.
...
def main():
    parser = argparse.ArgumentParser(
        description="Broadcast Craft CLI – History Twist Orchestrator",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  %(prog)s stage stage_01 --character 项羽 --event 垓下之战 --length 60s --platform 抖音
  %(prog)s validate stage_01 --file output.json
  %(prog)s pipeline --character 项羽 --event 垓下之战
        """,
    )
